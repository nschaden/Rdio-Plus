...
var ExtraControls = function($)
{
	...
	function keyCheck(event)
	{
		...
		// for Ctrl + F, switch to full screen mode
		...
		// for Ctrl + H, jump to home/dashboard
		...
		// for Ctrl + J, run Echonest search based on current artist
		...
		// for Ctrl + K, run Echonest search based on current song
		...
		// for Ctrl + L, jump focus to search box
		if (event.ctrlKey && event.keyCode == 12)
		{
		...
		// for Ctrl + N, jump to history
		if (event.ctrlKey && event.keyCode == 14)
		{
			event.preventDefault();
			jumpToNewURL(getHomeURL() + 'history/');
		}
		
		// for Ctrl + P, jump to playlists
		...
		// for Ctrl + X, toggle shuffle
		if (event.ctrlKey && event.keyCode == 24)
		{
...
var QuickAdd = function($)
{
	...
	function initHelpScreen()
   	{
		var helpscreen = $('<div id="extracontrols_help" style="display: none; width: 100%; height: 110%; position: absolute; background: rgba(0,0,0,0.7); top: 0; left: 0; z-index: 999999;"><h2 style="font-size: 1.2em; margin-bottom: 0.5em; padding: 5px;">Keyboard Shortcuts</h2><table><tr><td>Left</td><td>Previous Track</td></tr><tr><td>Right</td><td>Next Track</td></tr><tr><td>Spacebar</td><td>Play/Pause</td></tr><tr><td>Cmd+U</td><td>Now Playing</td></tr><tr><td>Ctrl+C</td><td>Collection</td></tr><tr><td>Ctrl+F</td><td>Full Screen</td></tr><tr><td>Ctrl+H</td><td>Home (Dashboard)</td></tr><tr><td>Ctrl+J</td><td>Echonest artist</td></tr><tr><td>Ctrl+K</td><td>Echonest song</td></tr><tr><td>Ctrl+L</td><td>Search focus</td></tr><tr><td>Ctrl+M</td><td>Queue</td></tr><tr><td>Ctrl+N</td><td>History</td></tr><tr><td>Ctrl+P</td><td>Playlists</td></tr><tr><td>Ctrl+X</td><td>Shuffle toggle</td></tr><tr><td>Ctrl+Z</td><td>Repeat toggle</td></tr><tr><td>Ctrl+,</td><td>Help</td></tr></table></div>');
	...
	exports.initHelpScreen = initHelpScreen;
